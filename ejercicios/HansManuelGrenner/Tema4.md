...
1. Generamos el fichero 'configure'.

	```./autogen.sh```

2. Configuramos el paquete para nuestro sistema.

	```./configure```

3. Compilamos el paquete

	```make```

4. Iniciamos la instalación de los programas junto a los ficheros de datos y su documentación.
